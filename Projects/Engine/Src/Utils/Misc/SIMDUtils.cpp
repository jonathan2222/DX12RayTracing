...
void RS::Utils::SIMDMemCopy(void* __restrict _Dest, const void* __restrict _Source, size_t NumQuadwords)
{
    RS_ASSERT(Utils::IsAligned(_Dest, 16));
    RS_ASSERT(Utils::IsAligned(_Source, 16));
...
void RS::Utils::SIMDMemFill(void* __restrict _Dest, __m128 FillVector, size_t NumQuadwords)
{
    RS_ASSERT(Utils::IsAligned(_Dest, 16));
