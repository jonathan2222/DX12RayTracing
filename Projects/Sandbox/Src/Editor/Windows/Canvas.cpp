...
void RSE::Canvas::Init()
{
    ...
    // Texture
    {
        ...
        m_NormalTexture = pCommandList->CreateTexture((uint32)w, (uint32)h, data,
            RS::DX12::GetDXGIFormat(requestedChannelCount ? requestedChannelCount : n, 8, RS::DX12::FormatType::UNORM),
            "FlyToYTourDeam Texture Resource");
    ...
    // Null Texture
    {
        ...
        m_NullTexture = pCommandList->CreateTexture((uint32)w, (uint32)h, data,
            RS::DX12::GetDXGIFormat(requestedChannelCount ? requestedChannelCount : n, 8, RS::DX12::FormatType::UNORM),
